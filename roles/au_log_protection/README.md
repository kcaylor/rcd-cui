...
This role implements AU family CUI controls for hosts in the {{ cui_zone }} zone.
...
- Uses control tags r2_3.3.9 and r3_03.03.09 with family_AU and zone_{{ cui_zone }} on all tasks.
