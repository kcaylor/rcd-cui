...
This role implements AC family CUI controls for hosts in the {{ cui_zone }} zone.
...
- Uses control tags r2_3.1.10 and r3_03.01.10 with family_AC and zone_{{ cui_zone }} on all tasks.
